...
namespace GUIOpenGuestHouse
{
    class DBAccess
    {
        ...
        private static string strConnString = "Data Source=desktop-n9ligo7;Initial Catalog=OGHdb;Integrated Security=True;Encrypt=False";
        ...
        public void readDatathroughAdapterSql(SqlCommand cmd, DataTable tblName)
        {
            try
            {
